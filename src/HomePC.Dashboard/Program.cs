...
var config = JsonSerializer.Deserialize<HomePcConfig>(File.ReadAllText(configPath), jsonOptions) ?? throw new InvalidDataException("Configuration is empty.");
