/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: e5f684129d219d493f27785d6be7e446)
// Runtime types generated with workerd@1.20260721.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	ACCESS_TOKEN_TTL_SECONDS: "3600";
	AUTH_CODE_TTL_SECONDS: "300";
	COMMAND_TIMEOUT_MS: "8000";
	HOMEPC: DurableObjectNamespace<import("./index").HomePcObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "HomePcObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TOKEN_TTL_SECONDS" | "AUTH_CODE_TTL_SECONDS" | "COMMAND_TIMEOUT_MS">> {}
}
